(function (window) {
    ...
    if (!AMapUI || !AMapUI.requirejs) {
      ...
      !function (global, setTimeout) {
        ...
        function newContext(e) {
          ...
          function l() {
            var e, t, r = 1e3 * w.waitSeconds, o = r && q.startTime + r < (new Date).getTime(), a = [], s = [], u = !1,
              f = !0;
            if (!x) {
          ...
          var x, b, q, y, E,
            w = {waitSeconds: 7, baseUrl: "./", paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {}}, M = {}, S = {},
            A = {}, O = [], k = {}, j = {}, I = {}, C = 1, T = 1;
          return y = {
            require: function (e) {
  ...
  AMapUI.define("lib/SphericalMercator", [], function () {
    ...
    var scaleCache = {}, earthDiameter = 12756274, deg2rad = Math.PI / 180, rad2deg = 180 / Math.PI,
      quadPI = Math.PI / 4, half2PI = .5 / Math.PI;
    return {
